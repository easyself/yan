...
<a name="nQhTY"></a>
### 2. 编辑器选项卡
当 vscode 打开很多文件，如果 "**设置→工作台→编辑器管理→Tab Sizing**" 为 "**fit**"，编辑器选项卡将使用滚动隐藏的方式显示，想要显示打开的编辑器可以使用 `edt` 的命令或者设置 "**Show All Editors**" 的快捷键。<br />![vscode-fit-tab.png](https://qiniu.bioinit.com/yuque/0/2019/png/126032/1565228022826-acac4d0f-fccc-4383-a17f-8d5514445fdc.png#align=left&display=inline&height=320&name=vscode-fit-tab.png&originHeight=320&originWidth=772&size=69688&status=done&width=772)
